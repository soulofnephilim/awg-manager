...
// orchestrator slots other than the device-proxy slot itself — exactly
// the set pruneDanglingSelectorRefsLocked treats as valid selector
// members before every reload. Service.buildSpec uses it to keep
